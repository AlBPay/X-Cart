<link rel="stylesheet" href="https://payment.albpay.io/latest/checkout.css">
...
<div id="app"></div>
<script src="https://payment.albpay.io/latest/checkout.js"></script>
<script>
    var maxOptions = {
        options: {
